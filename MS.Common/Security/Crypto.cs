...
{
    /// <summary>
    /// 这段代码是从开源nuget包CryptoHelper中扒下来的。
    ...
    public static class Crypto
    {
        ...
        /// 校验密码
        /// </summary>
        /// <param name="hashedPassword">加密的密码（数据库中的加密密码）</param>
        /// <param name="password">要验证的密码（一般是明文）</param>
        /// <returns></returns>
        ...
        private static byte[] HashPasswordInternal(string password,KeyDerivationPrf prf,int iterCount,int saltSize,int numBytesRequested)
        {
